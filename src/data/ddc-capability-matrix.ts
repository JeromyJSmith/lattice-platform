...
export const ddcCapabilities: Array<DdcCapability> = [
  ...
  },
  {
    ...
    currentState:
      "Governed Juniper orchestrator now extracts quantities, reuses cost-search writeback, drives BOQ sync plus BOQ read/export, captures structured evidence for the same project scope, and is backed by a bounded estimation contract package with traceability-aware fixtures",
    gap: "No current runtime proof gap; follow-on work is broadening the same contract-backed runtime beyond the bounded Juniper fixture and wiring direct operator dispatch onto the same evidence contract.",
    priority: "high",
    wave: "wave-2",
  ...
  },
  {
    ...
    currentState:
      "Verifier-backed Juniper end-to-end governed estimation proof now passes with dependency reuse, writeback, BOQ linkage, read/export round-trip, explicit evidence, and a dual contract package covering workbook evidence, operational entities, fixtures, expected failures, and traceability",
    gap: "No current proof gap; follow-on work is broadening the same governed estimation contract beyond Juniper, extending the partial Juniper fixture set, and wiring the promoted evidence trail into the admin planning surface.",
    priority: "high",
    wave: "wave-2",
    validation:
      "MARPA — 918 Juniper Avenue runs end to end through the governed estimation path with dependency evidence, BOQ linkage, explicit blocker capture, and passing contract-package validation.",
