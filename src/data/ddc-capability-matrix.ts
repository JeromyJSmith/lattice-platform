...
export const ddcSurfaces: Array<DdcSurface> = [
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/skills/README.md',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/cwicr/README.md',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/erp/README.md',
    classification: 'direct runtime feature',
    adoptionMode: 'adapted to LATTICE',
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/n8n/README.md',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/admin/README.md',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/converters/README.md',
...
export const ddcCapabilities: Array<DdcCapability> = [
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/skills/',
    targetSurface: '/home/runner/work/lattice-platform/lattice-platform/skills/ddc/',
    currentState: 'Docs only; sync pending',
    gap: 'Pull the upstream skill corpus into the local skill tree.',
    priority: 'high',
    wave: 'wave-1',
    validation: 'Skill count and metadata completeness match the harvested inventory.',
  },
  {
    ...
    priority: 'high',
    wave: 'wave-1',
    validation: 'Semantic search returns DDC skill matches for construction intents.',
  },
  {
    ...
    priority: 'medium',
    wave: 'wave-3',
    validation: 'DDC skill queries resolve against semantic_sidecars with usable rankings.',
  },
  {
    id: 'cwicr-seed',
    capability: 'CWICR dataset seeding',
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/cwicr/seed-qdrant.sh',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/cwicr/cost-search.py',
    targetSurface: 'POST /v1/erp/cost-search',
    currentState: 'Python stub',
    gap: 'Execute vector search and return ranked cost matches.',
    priority: 'high',
    wave: 'wave-1',
    validation: 'Element descriptions return region-filtered ranked CWICR matches.',
  },
  {
    ...
    priority: 'high',
    wave: 'wave-2',
    validation: 'ifc_elements rows show unit cost, region, and freshness timestamps.',
  },
  {
    id: 'boq-sync',
    capability: 'BOQ creation and sync',
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/erp/boq-adapter.py',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/erp/cost-export.py',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/erp/phase-adapter.py',
    targetSurface: 'POST /v1/erp/phases',
    currentState: 'Adapter stub',
    gap: 'Join schedule phases to IFC rows and push ERP phase assignments.',
    priority: 'high',
    wave: 'wave-2',
    validation: 'Project phase records in the ERP align with local schedule metadata.',
  },
  {
    id: 'admin-sql',
    ...
    priority: 'high',
    wave: 'wave-3',
    validation: 'Admin panels resolve against parquet exports without ad-hoc SQL.',
  },
  {
    id: 'admin-route',
    capability: 'Admin dashboard route',
    localHome: '/home/runner/work/lattice-platform/lattice-platform/src/routes/admin/index.tsx',
    targetSurface: '/admin',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/meta/FEATURE_BACKLOG.md',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/n8n/workflows/',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/n8n/pipeline-templates/',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/ddc/converters/INSTALL.md',
  ...
  },
  {
    ...
    localHome: '/home/runner/work/lattice-platform/lattice-platform/reality/mirror/README.md',
    ...
    priority: 'medium',
    wave: 'wave-4',
    validation: 'Mirror state reflects DDC freshness alongside the other platform layers.',
  },
  {
    id: 'ddc-evidence',
    ...
    priority: 'high',
    wave: 'wave-1',
    validation: 'DDC actions are queryable in evidence and stream-event tables.',
  },
]
...
export const ddcPipelineStages: Array<DdcPipelineStage> = [
  ...
  },
  {
    ...
    capabilityIds: ['admin-sql', 'admin-route', 'cost-per-zone', 'cost-overlay', 'skills-search-api'],
  },
  {
    id: 'wave-4',
    name: 'Resilience',
...
export const ddcSummary = {
  ...
  highPriorityCount: ddcCapabilities.filter((capability) => capability.priority === 'high').length,
  mediumPriorityCount: ddcCapabilities.filter((capability) => capability.priority === 'medium').length,
  lowPriorityCount: ddcCapabilities.filter((capability) => capability.priority === 'low').length,
}
