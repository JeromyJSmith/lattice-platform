...
def main():
    ...
    `use_reloader=False` keeps in-flight benchmark requests alive when YAML
    files or modules get edited. Set BENCHY_DEBUG=1 to re-enable reload.
    """
    import os
    debug = bool(os.getenv("BENCHY_DEBUG"))
