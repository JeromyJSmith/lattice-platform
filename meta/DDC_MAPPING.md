...
- already helping now: `cwicr-seed`, `cwicr-qdrant-cost-search`, `ifc-cost-enrichment`, `boq-sync`, `boq-read`, `boq-export`, `phases-sync`, `quantity-takeoff-agent`
...
This capability is green because Juniper Avenue now runs end to end through the governed estimation path with explicit evidence, BOQ linkage, and blocker capture.
