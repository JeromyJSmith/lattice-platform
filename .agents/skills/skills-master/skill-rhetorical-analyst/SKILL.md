...
Take the opponent's own framing or question, quote it exactly, pause, then answer it with maximum compression and minimum words. The gap between the apparent specificity of the question and the brevity — or total generality — of the answer creates the rhetorical force. # allow-forbidden
